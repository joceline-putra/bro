...
CREATE TABLE `accounts` (
  ...
  `account_locked` int(5) DEFAULT 0 COMMENT '1=Lock, 0=Free',
...
) ENGINE=InnoDB AUTO_INCREMENT=1462 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `approvals` (
  ...
  `approval_from_id` bigint(255) DEFAULT NULL COMMENT 'ID From Order, Trans, Journal',
...
CREATE TABLE `balances` (
  ...
  `balance_flag` int(11) DEFAULT NULL COMMENT '0=Pending, 1=Valid, 4=Delete',
  ...
  `balance_position` int(11) DEFAULT NULL COMMENT '1=In, 2=Out',
  `balance_user_id` bigint(20) DEFAULT NULL COMMENT 'TRIGGER',
  `balance_bank_id` bigint(20) DEFAULT NULL COMMENT 'TRIGGER',
  `balance_date_delete_by_sp` datetime DEFAULT NULL COMMENT 'CRON n SP',
  `balance_uniq` int(11) DEFAULT 0,
...
CREATE TABLE `banks` (
  ...
  `bank_minute_interval` int(11) DEFAULT NULL COMMENT 'Not Used',
...
CREATE TABLE `countries` (
  ...
  `country_phone` int(11) DEFAULT NULL,
  `country_default` int(1) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `devices` (
  ...
  `device_mail_port` int(50) DEFAULT NULL COMMENT '465, 587, 25',
...
CREATE TABLE `journals` (
  ...
  `journal_id_source` bigint(255) DEFAULT NULL COMMENT 'Hanya Asset yg menggunakan',
  `journal_asset_id` bigint(255) DEFAULT NULL COMMENT 'Relasi products = product_type=3',
  `journal_total_2` double(18,2) DEFAULT 0.00,
  `journal_cashback` int(5) DEFAULT 0 COMMENT '1=Cashback, 0=Not Cashback',
...
CREATE TABLE `journals_items` (
  ...
  `journal_item_order_id` bigint(255) DEFAULT NULL,
...
CREATE TABLE `links` (
  `link_id` bigint(255) NOT NULL AUTO_INCREMENT,
  ...
  `link_flag` int(5) DEFAULT NULL COMMENT '1=Publish, 0=Unpublish',
  `link_visit` bigint(255) DEFAULT 0 COMMENT 'Trigger',
...
CREATE TABLE `links_hits` (
  ...
  PRIMARY KEY (`hit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2797 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `locations` (
  ...
  `location_allow_radius` varchar(255) DEFAULT NULL,
...
CREATE TABLE `messages` (
  ...
  `message_branch_id` bigint(255) DEFAULT NULL,
  `message_type` int(11) DEFAULT 1 COMMENT 'Not USED 1=text, 2=image, 3=video, 4=document',
  `message_news_id` bigint(255) DEFAULT NULL,
  `message_platform` int(5) DEFAULT 1 COMMENT '1=Whatsapp, 2=Telegram, 3=SMS, 4=Email',
  `message_session` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `message_group_session` varchar(255) DEFAULT NULL COMMENT 'Sent always by this value enqueque',
  ...
  `message_text` blob DEFAULT NULL,
  `message_url` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `message_subject` varchar(255) DEFAULT NULL COMMENT 'Wajib diisi jika message_platform=4',
  ...
  `message_contact_email` varchar(255) DEFAULT NULL COMMENT 'Email, Wajib jika message_platform=4',
...
CREATE TABLE `orders` (
  ...
  `order_contact_id_2` bigint(255) DEFAULT NULL COMMENT 'Waitress, Employee Contact ID',
  ...
  `order_with_dp_account` bigint(20) DEFAULT NULL,
  ...
  `order_sales_id` bigint(255) DEFAULT NULL,
  ...
  `order_approval_count` int(50) DEFAULT 0 COMMENT 'Trigger approval',
  `order_files_count` int(50) DEFAULT 0 COMMENT 'Trigger files',
...
CREATE TABLE `orders_items` (
  ...
  `order_item_ref_id` int(5) DEFAULT NULL COMMENT 'Room, Meja Ref ID',
  `order_item_contact_id` int(5) DEFAULT NULL COMMENT 'Customer, Supplier Contact ID',
  `order_item_contact_id_2` int(5) DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=404 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `printers` (
  `printer_id` bigint(255) NOT NULL AUTO_INCREMENT,
  `printer_parent_id` bigint(255) DEFAULT NULL COMMENT 'Relasi ke printer',
  `printer_type` int(5) DEFAULT NULL COMMENT '1=Deksjet, 2=DotMatrik, 3=Labelworks, 4=Thermal',
...
CREATE TABLE `recipients` (
  ...
  `recipient_branch_id` bigint(255) DEFAULT NULL,
  `recipient_group_id` bigint(255) DEFAULT NULL,
  `recipient_name` varchar(255) DEFAULT NULL,
  `recipient_phone` varchar(255) DEFAULT NULL,
  `recipient_email` varchar(255) DEFAULT NULL,
  `recipient_birth` date DEFAULT NULL,
  `recipient_session` varchar(255) DEFAULT NULL,
  `recipient_date_created` datetime DEFAULT NULL,
  `recipient_flag` int(5) DEFAULT 1,
...
CREATE TABLE `recipients_groups` (
  ...
  `group_branch_id` int(255) DEFAULT NULL,
  `group_name` varchar(255) DEFAULT NULL,
  `group_date_created` datetime DEFAULT NULL,
  `group_flag` int(5) DEFAULT NULL,
  `group_count` bigint(255) DEFAULT 0,
  PRIMARY KEY (`group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `taxs` (
  `tax_id` int(5) NOT NULL AUTO_INCREMENT,
  ...
  `tax_flag` int(5) DEFAULT 0 COMMENT '1=Aktif, 0=Nonaktif, 2=Tidak (Default)',
...
CREATE TABLE `trans` (
  ...
  `trans_sales_id` bigint(50) DEFAULT NULL,
  `trans_sales_name` varchar(255) DEFAULT NULL,
  `trans_voucher_id` bigint(255) DEFAULT NULL,
  `trans_approval_count` int(50) DEFAULT 0 COMMENT 'Trigger approval',
  `trans_files_count` int(50) DEFAULT 0 COMMENT 'Trigger files',
  `trans_branch_id_2` bigint(255) DEFAULT NULL,
  `trans_person_name` varchar(255) DEFAULT NULL COMMENT 'Penerima',
...
CREATE TABLE `types_paids` (
  `paid_id` bigint(255) NOT NULL AUTO_INCREMENT COMMENT 'Petunjuk trans=trans_paid_type',
  `paid_name` varchar(255) DEFAULT NULL,
  `paid_note` varchar(255) DEFAULT NULL,
  `paid_image` varchar(255) DEFAULT NULL,
  `paid_flag` int(5) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `user_contact_id` int(50) DEFAULT NULL,
...
CREATE TABLE `vendors_logs` (
  `log_id` bigint(255) NOT NULL AUTO_INCREMENT,
  `log_vendor_id` int(5) DEFAULT NULL COMMENT 'Vendor ID',
  `log_vendor_name` varchar(255) DEFAULT NULL COMMENT 'Trigger Vendor Name',
  `log_message` blob DEFAULT NULL COMMENT 'Callback POST Decode',
  `log_flag` int(5) DEFAULT NULL,
...
CREATE TABLE `vouchers` (
  `voucher_id` bigint(255) NOT NULL AUTO_INCREMENT,
  `voucher_type` int(5) DEFAULT NULL COMMENT '1=Voucher, 2=Promo',
  ...
  `voucher_url` blob DEFAULT NULL COMMENT 'Voucher Gambar Alamat',
  `voucher_user_id` bigint(255) DEFAULT NULL,
  `voucher_flag` int(5) DEFAULT NULL COMMENT '1=Aktif, 0=Nonaktif, 4=Hapus',
  ...
  `voucher_trans_count` int(255) DEFAULT 0 COMMENT 'Trigger yg mengisi',
...
CREATE TABLE `vendors` (
  ...
  `vendor_token` blob DEFAULT NULL,
  `vendor_url` varchar(255) DEFAULT NULL,
  `vendor_flag` int(11) DEFAULT NULL,
...
ALTER TABLE orders_items ADD order_item_start_date DATETIME;
ALTER TABLE orders_items ADD order_item_end_date DATETIME;
ALTER TABLE orders_items ADD order_item_checkin_date DATETIME;
ALTER TABLE orders_items ADD order_item_checkout_date DATETIME;
ALTER TABLE orders_items ADD order_item_flag_checkin INT(5);
ALTER TABLE orders_items ADD order_item_expired_day INT(5);
ALTER TABLE orders_items ADD order_item_parent_id INT(50);

ALTER TABLE orders ADD order_total_paid DOUBLE(18,2) DEFAULT 0;
ALTER TABLE orders ADD order_paid INT(5) DEFAULT 0;
ALTER TABLE orders ADD order_uniq_fee DOUBLE(18,2) DEFAULT 0 AFTER order_total_dpp;
ALTER TABLE orders ADD order_service_fee DOUBLE(18,2) DEFAULT 0 AFTER order_uniq_fee;
