...
class Menu_model extends CI_Model{
    ...
    function get_all_menus_custom($params = null, $search = null, $limit = null, $start = null, $order = null, $dir = null) {
        ...
        $this->db->select("parent.menu_id AS parent_id, parent.menu_name AS parent_name, parent.menu_icon AS parent_icon, parent.menu_flag AS parent_flag");
        ...
        $this->db->join("(SELECT menu_id, menu_icon, menu_name, menu_flag FROM menus WHERE menu_parent_id=0) AS parent","parent.menu_id=child.menu_parent_id","RIGHT");
    ...
    */        
    ...
    function update_menu_custom($where,$params){
        $this->db->where($where);
        return $this->db->update('menus',$params);
    }    
