    ...
    function report(){
        ...
        */
        ...
        if(($request=='trans_recap') && ($format=='html')){
            ...
            $text .= dot_set_wrap_0('End Date   '.date("d-M-Y, H:i",strtotime($date_end))," ","RIGHT");
            $text .= dot_set_wrap_2('Sold Items',number_format($get_t_out['trans_item_out_qty']));                                  
            $text .= dot_set_line('-',$word_wrap_width);

            //Cash Management
            // $text .= dot_set_wrap_1('CASH MANAGEMENT');       
            // $text .= dot_set_line('-',$word_wrap_width); 
            // $text .= dot_set_wrap_2('Start Cash',number_format($total_start_cash));
            // $text .= dot_set_wrap_2('Cash Payment',number_format($total_paid_cash));
            // $text .= dot_set_wrap_2('Expected',number_format($total_expected));                   
            // $text .= dot_set_wrap_2('Actual',number_format($total_actual));                           
            // $text .= dot_set_wrap_2('Different',number_format($total_different));                                   
            // $text .= dot_set_line('-',$word_wrap_width);
            ...
            //Summary
            $text .= dot_set_wrap_2('TOTAL PAYMENT',number_format($total_paid));             
        }
