                            ...
                            for ($i=1; $i<count($sheetData); $i++) {
                                if(($i>1) && (strlen($sheetData[$i][0]) > 0)){
                                    if ($contact_type == 1) { //Supplier              
                                        $contact_code = $sheetData[$i][0];
                                        $contact_name = $sheetData[$i][1];
                                        $contact_address = $sheetData[$i][2];
                                        $contact_phone = $sheetData[$i][3];
                                        $contact_email = $sheetData[$i][4];
                                        ...
                                        $contact_phone = $sheetData[$i][3];
                                        $contact_email = $sheetData[$i][4];
                                        $contact_employee_number = $sheetData[$i][5];
