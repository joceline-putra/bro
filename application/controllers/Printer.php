...
class Printer extends MY_Controller{
    ...
    function matrix(){ // Dot Matrik -> mPDF
    ...
    function barcode(){ //Barcode C128C -> mPDF
    ...
    function struk(){ // RawBT Receipt
        ...
        if(fclose($file)){
            // echo json_encode(array('status'=>1,'print_url'=>base_url('print.txt'),'print_to'=>1));
        }else{
            // echo json_encode(array('status'=>0,'message'=>'Print raw error','print_to'=>1));
        }
