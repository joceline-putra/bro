...
class Pos3 extends MY_Controller{
    ...
    function __construct(){
        ...
        $this->print_to         = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? 0 : 0); //0 = Local, 1 = Bluetooth
        ...
        if ($this->input->post()) {    
            ...
            if(!empty($data['app_item']) && ($data['app_item']['support_point_of_sale'] == "Yes")){            
                ...
                */
                ...
                $data['journal_alias']    = $this->journal_alias;            
    ...
    function report(){
        ...
        */
        ...
        if(($request=='trans_recap') && ($format=='html')){
            ...
            $text .= dot_set_wrap_0('Start Date '.date("d-M-Y, H:i",strtotime($set_date_start))," ","RIGHT");
            $text .= dot_set_wrap_0('End Date   '.date("d-M-Y, H:i",strtotime($set_date_end))," ","RIGHT");
