...
class Asset extends MY_Controller{
    ...
    function index(){
        ...
        if ($this->input->post()) {    
            ...
            switch($action){
                case "load": //Works
                    ...
                    */
                    ...
                    $datas = [];
                    $get_count = $this->Asset_model->get_all_asset_count($params,$search);
                ...
                case "load_depreciation":
                    ...
                    */
                    ...
                    if($post['asset_id'] && $post['asset_id'] > 0) {
                        $params['journal_asset_id'] = intval($post['asset_id']);
                    }
            ...
            if(!empty($data['app_item']) && ($data['app_item']['support_fixed_asset'] == "Yes")){
                ...
                */
                ...
                $file_js = 'layouts/admin/menu/asset/index_js';                    
            }else{ 
