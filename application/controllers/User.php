                ...
                case "create":
                    ...
                    */
                    ...
                    if($check_exists==false){
                        ...
                        $post_upload = !empty($data['file']) ? $data['file'] : "";
                        if(strlen($post_upload) > 10){
                            ...
                            $upload_process = upload_file_base64($this->folder_upload,$post_upload, $image_config);
                            if($upload_process['status'] == 1){
                                $params['user_image'] = $upload_process['result']['file_location'];                          
                            }
                        }
                        ...
                        */
                        ...
                        if($check_exists==false){
                            ...
                            if(strlen($post_upload) > 10){
                                ...
                                if($upload_process['status'] == 1){
                                    $params['user_image'] = $upload_process['result']['file_location'];
                                    if ($get_old_data && $get_old_data['user_image']) {
                                        // $params['user_image_size'] = $upload_process['result']['file_size'];
                                        if (!empty($get_old_data['user_image'])) {
                                            if (file_exists(FCPATH . $get_old_data['user_image'])) {
                                                unlink(FCPATH . $get_old_data['user_image']);
                                            }
                                        }
                                    }                          
                                }
