...
<script>
    ...
    $(document).ready(function () {
        ...
        console.log('Pos2 : ref -> trans-journal (Pilih Meja -> Transaksi-Bayar)');
        // Start of Daterange
        ...
        */
        ...
        let trans_table = $("#table_trans").DataTable({
            ...
            "columns": [{
                    ...
                    render: function (data, meta, row) {
                        var dsp = '';
                        dsp += '&nbsp;<button class="btn_print_payment btn btn-mini btn-success" data-id="' + row.trans_id + '" data-session="'+row.trans_session+'" data-number="'+row.trans_number+'">';
                        dsp += '<span class="fas fa-print"></span>';
                        dsp += '</button>';
