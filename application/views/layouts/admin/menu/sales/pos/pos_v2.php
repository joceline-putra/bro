...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <ul class="nav nav-tabs" role="tablist" style="display:inline;">
            ...
            <li class="hide" style="<?php echo $class; ?>">
                                ...
                                <div class="pull-left">
                                    <div class="btn-group"> 
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="#" class="btn_menu_toggle" data-id="6"><span class="fas fa-list-alt"></span>&nbsp;Antrian Pembayaran</a></li>                
                                            <li><a href="#" class="btn_menu_toggle" data-id="7"><span class="fas fa-list-alt"></span>&nbsp;Voucher & Promo</a></li>                                            
                                        </ul>
                                    </div>                                                       
                                </div>
                            </div> 
