<style>
    *,*:before,*:after{
    ...
    /* Scroll */
        ...
        .scroll-order-product-categories > li > a{    
            color:var(--form-font-color)!important;      
        } 
        .scroll-order-product-categories > li.active > a{    
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <ul class="nav nav-tabs" role="tablist" style="display:inline;">
            <?php 
            if($session['user_data']['user_id'] == 1){ $class=""; } else{ $class = 'display:none;'; } ?>
            <li class="active" style="<?php echo $class; ?>">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                    <div class="grid simple">
                                        ...
                                        <div class="grid-body" style="padding:0px;background-color:var(--form-background-color);">
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                <h5 style="margin-top:8px!important;margin-bottom:0px!important;padding-left:8px;color:var(--form-font-color);"><b>Produk</b></h5>
                                                ...
                                                <div id="product-tab" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-remove-side tabbable tabs-left" style="border-top:var(--form-background-color);border-top: 1px solid var(--form-background-color);border-bottom: 1px solid var(--form-background-color);">
                                                    <ul class="nav nav-tabs scroll-nav scroll-order-product-categories" id="style-5" role="tablist" style="height:480px;background-color: var(--form-background-color)!important;">
                                                    ...
                                                    <div class="tab-content" style="height:480px;margin-bottom: 0px!important">
                                                        <div class="tab-pane active" style="padding-top:0px;padding-bottom:0px;">
                                                            <div class="row">                                                   
