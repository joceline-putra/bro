        ...
        <!--<div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">-->
            ...
            <table class="table table-bordered table-hover">
                <thead>
                    <tr style="background-color:#eaeaea;">
                        ...
                        <td><b>Gudang Masuk</b></td>                        
                        <td style="text-align:right;"><b>Qty Masuk</b></td>      
            ...
            <tbody>
                ...
                foreach($content as $v):
                    $item_total = $v['trans_item_in_price']*$v['trans_item_in_qty'];
                ?>
                <tr data-trans-id="<?php echo $v['trans_id'];?>">
                     ...
                     <td class="text-right"><?php echo $v['trans_item_in_qty'].' '.$v['trans_item_unit'];?></td>                                                                               
                     <td style="text-align:right;"><?php echo number_format($v['trans_item_in_price']);?></td>    
                     <td style="text-align:right;"><?php echo number_format($item_total);?></td>                                                           
                 </tr>    
                <?php 
                $total_qty = $total_qty + $v['trans_item_in_qty'];
                $total_trans = $total_trans + $v['trans_item_in_price'];
