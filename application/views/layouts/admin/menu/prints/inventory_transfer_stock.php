  ...
  <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:4px;">
        <p>
          <div class="col-md-7" style="padding-left:0;">
            ...
            <?php echo '['.$location['location_from']['location_code'].'] '.$location['location_from']['location_name'];?><br>
          </div>
          <div class="col-md-5" style="padding-left:0;">
            <b>Gudang Penempatan Tujuan:</b><br>
            <?php echo '['.$location['location_to']['location_code'].'] '.$location['location_to']['location_name'];?><br>
          </div>          
        </p>
      </div>      
      -->
    ...
    <!-- CONTENT -->
      <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:15px;">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            $total_sub2 = 0;
            echo '<tr>
              <td colspan="7"><b>OUT - Produk Keluar</b></td>
            </tr>';
            echo '<tr>
              ...
              <th class="text-left">Lokasi Asal Pengambilan</th>
            </tr>';            
            foreach($content as $i => $v){
                $location_from = $v['location_name'];
            ...
            echo '<tr>
              <td colspan="7"><b>IN - Produk Masuk</b></td>
            </tr>';
            echo '<tr>
              <th class="text-right">No</th>
              <th class="text-left">Produk</th>
              ...
              <th class="text-right">Harga Satuan</th>                           
              <th class="text-right">Total</th>
              <th class="text-left">Lokasi Tujuan Penempatan</th>
            </tr>';            
            $num = 1;
            foreach($content as $i => $v){
                $location_from = $v['location_name'];
                if($v['trans_item_position'] ==1){
                  ...
                  $total_sub2 = $total_sub2 + $price_qty;
                  echo '<tr>';
                    echo '<td class="text-right">'.$num++.'</td>';
                    echo '<td>'.$v['product_name'].'</td>';
      ...
      <div class="col-md-12 col-xs-12" style="">
        Total Nilai Produk :<br>&nbsp;<?php echo '<b>'.number_format($total_sub,2,'.',',').'</b>';?><br>
      </div>      
      <div class="col-md-12 col-xs-12" style=""><br>
        Catatan:<?php echo $header['trans_note'];?>
      </div>      
    </div>
  </div>
</div>
