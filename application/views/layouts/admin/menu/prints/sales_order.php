        ...
        <p>
          ...
          <div class="col-xs-6">
            <table>
              ...
              <tr><td>Nomor Referensi</td><td>: <?php echo $header['order_ref_number'];?></td></tr>
              <tr><td>Sales</td><td>: <?php echo !empty($header['order_sales_id']) ? $header['order_sales_name'] : '-';?></td></tr>
            </table>
          </div>          
        </p>
      </div>      
