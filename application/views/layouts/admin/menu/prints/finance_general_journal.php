          ...
          <tbody>
            ...
            foreach($content as $v){
              ...
              echo '<tr>';
                ...
                echo '<td style="text-align:right;">'.number_format($v['journal_item_credit'],2,'.',',').'</td>';                                
              echo '</tr>';
            }
              ...
              echo '<tr>';
                ...
                echo '<td style="text-align:right"><b>'.number_format($subtotal_debit,2,'.',',').'</b></td>';
                echo '<td style="text-align:right"><b>'.number_format($subtotal_credit,2,'.',',').'</b></td>';                
              echo '</tr>';
            ?>
          </tbody>
        </table>
