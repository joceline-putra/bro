                ...
                <div class="col-md-8 col-sm-12 col-xs-12" style="">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:4px;">
                        ...
                        <div class="col-xs-7" style="padding-left:0;">
                            <b>Cabang Peminta:</b><br>
                            <?php echo $header['branch_2_name']; ?><br>
                        </div>
                        <div class="col-xs-5">
                            <table>
                                <tr><td>Tanggal</td><td>: <?php echo date("d-M-Y", strtotime($header['trans_date'])); ?></td></tr>
                                <tr><td>User By</td><td>: <?php echo $header['user_username']; ?></td></tr>                           
                            </table>
                        </div>          
                        </p>
                    </div>      
                            ...
                            <tbody>
                                ...
                                foreach ($content as $v) {
                                    if ($v['trans_item_position'] == 2) {
                                        ...
                                        $total_stok = $total_stok + $v['trans_item_out_qty'];
                                        echo '<tr>';
                                ...
                                // echo '<td class="text-right"><b>' . number_format($total_stok, 2, '.', ',') . '</b></td>';
                                // echo '<td colspan="3"></td>';
                                // echo '<td style="text-align:right"><b>' . number_format($total_sub, 2, '.', ',') . '</b></td>';
                                // echo '</tr>';
                                ?>
                            </tbody>
                        </table>        
