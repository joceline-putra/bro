  ...
  <div class="row">
    <div class="col-md-8 col-sm-12 col-xs-12" style="">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:4px;">
        <p>
          ...
          <div class="col-xs-5">
            <table>
              <tr><td>Document Date</td><td>: <?php echo date("d-M-Y", strtotime($header['order_date']));?></td></tr>
              <!-- <tr><td>Due Date</td><td>: <?php echo date("d-M-Y", strtotime($header['order_date_due']));?></td></tr> -->
              <!-- <tr><td>Sales</td><td>:</td></tr> -->
              <!-- <tr><td>Customer Ref Num</td><td>:<?php echo $header['order_ref_number'];?></td></tr>                            -->
            </table>
          </div>          
        </p>
      </div>      
    ...
    <!-- CONTENT -->
        ...
        <tbody>
          ...
          foreach($content as $v){
            ...
            echo '<tr>';
              ...
              echo '<td style="text-align:right"><b>Total IDR</b></td>';
      ...
      <div class="col-md-12 col-xs-12" style="">
        Note:<?php echo $header['order_note'];?>
      </div>  

    <!-- FOOTER -->
      <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:25px;">
        <div class="col-md-3 col-xs-4">
          <b style="text-align:left;">Hormat Kami</b><br><br><br><br><br>
          <b style="text-align: center;">Yuliardianto</b><br> 
          <b style="text-align: center;">&nbsp;&nbsp;Komisaris</b>  
        </div>
      </div>        
    </div>
  </div>
