...
<div class="container-fluid">
  <div class="row">
  	...
  	<div class="col-md-6 col-sm-12 col-xs-12" style="border:1px solid gray;">
  		<!-- HEADER -->
        ...
        <p>
          ...
          <div class="col-xs-5">
            <table>
              ...
              <!-- <tr><td>Due Date</td><td>: <?php echo date("d-M-Y", strtotime($header['order_date_due']));?></td></tr> -->
              <!-- <tr><td>Sales</td><td>:</td></tr> -->
              <tr><td>Poli</td><td>: <?php echo $header['ref_code'].' - '.$header['ref_name'];?></td></tr>                           
              <tr><td class="text-left">Pembayaran</td><td>: Tunai</td></tr>                
            </table>
          </div>          
        </p>
      </div>      
  		...
  		<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:15px;">
 	 		<table class="table table-bordered">
 	 			<thead>
 	 				<tr>
            <th class="text-left">Description / Item</th>
      ...
      <div class="col-md-12 col-xs-12" style="">
        Note: <?php echo $header['order_note'];?><br>
        *Lembar untuk Klinik
      </div>	
    ...
    <div class="col-md-6 col-sm-12 col-xs-12" style="border:1px solid gray;">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <p>
          <div class="col-xs-3">
            <img src="../../<?php echo $result['branch']['branch_logo'];?>" class="img-responsive" style="width: 134px;">
          </div>
          <div class="col-xs-4">
          </div>
          <div class="col-xs-5 text-left">
