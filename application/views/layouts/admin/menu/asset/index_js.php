...
<script>
    $(document).ready(function () {
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                {"targets":0, "width":"8%", "title":"Tgl Akusisi", "searchable":true, "orderable":true},
                {"targets":1, "width":"10%", "title":"Detail Aset", "searchable":true, "orderable":true},
                {"targets":2, "width":"10%", "title":"Akun Aset", "searchable":true, "orderable":true},
                {"targets":3, "width":"8%", "title":"Biaya Akusisi", "searchable":true, "orderable":true},
                {"targets":4, "width":"8%", "title":"Nilai Buku", "searchable":true, "orderable":true},
                {"targets":5, "width":"20%", "title":"Action", "searchable":false, "orderable":false}                
            ],
            "order": [
                [0, 'asc']
            ],
            "columns": [
                {
                    ...
                    render: function (data, meta, row) {
                        ...
                        dsp += '<span class="fas fa-history"></span> Riwayat Susut';
                        dsp += '</button>';
        ...
        $(document).on("click", "#btn-save", function (e) {
            ...
            if (next) {
                if ($("#product_asset_fixed_account_id").find(':selected').val() === 0) {
                    next = false;
                    notif(0,'Akun Aset Tetap wajib dipilih');
                }
            }
        ...
        $(document).on("click", ".btn-delete", function () {
            ...
            $.confirm({
                ...
                onContentReady: function () {
                    this.setContentAppend('<div>Apakah anda ingin menghapus <b>' + number + '</b> ?<br>Data berikut akan dihapus juga jika berkaitan<ul><li>Data Pembelian</li><li>Data Penyusutan</li><li>Data Penjualan (jika ada)</li></ul></div>');
                },
                buttons: {
                    button_1: {
                        text: 'Hapus',
