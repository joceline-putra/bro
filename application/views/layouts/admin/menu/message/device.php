                                            ...
                                            <div class="div_whatsapp col-lg-12 col-md-12 col-xs-12 padding-remove-side" style="display:none;">                                            
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="auth" name="auth" type="text" value="" class="form-control" readonly='true' rows="6"></textarea>
                                                    </div>
                                                </div>   
                                                <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                    <div class="form-group">
                                                        <label class="form-label">Client ID (otomatis)</label>
                                                        <textarea id="client" name="client" type="text" value="" class="form-control" readonly='true'></textarea>
                                                    </div>
                                                </div>                    
                                            </div>
                                            <!--
            ...
            <form id="form-product" name="form-product" method="" action="">         
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <h4 id="qrcodes_label" style="text-align:center"></h4>
                            <p>Silahkan tutup jendela ini jika aplikasi WhatsApp telah berhasil tersambung</p>
                        </div>                        
                    </div>
                </div>
