    ...
    $(document).ready(function () {
        ...
        */
        ...
        $(document).on("click", ".btn_qrcode",function(e) {
            ...
            let content = 'Anda ingin request QR Code ?<br>Pastikan Aplikasi whatsapp anda sudah berada dalam posisi siap Scanning';
        ...
        function loadQRCode(params){
            ...
            forma.append('device_number', params['device_number']);            
            $.ajax({
                type: "post",
                url: url,
                data: forma, 
                ...
                success:function(d){
                    ...
                    if(parseInt(s) == 1){
                        ...
                        // if($('#device_media').val() == 'WhatsApp'){
                            var set_qrcode = d.result.result;
                            // $("#modal-qrcode").modal("toggle"); 
                            $("#qrcodes").attr('src',set_qrcode);
                            $("#qrcodes_label").html(params['device_number']);            
                        setTimeout(function(){
                            $("#modal-qrcode").modal("hide"); 
                        }, 4000);            
                    }else{
