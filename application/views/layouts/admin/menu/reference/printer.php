                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Teks to Print</label>
                                                    <textarea id="text" name="text" type="text" class="form-control" style="height:220px!important;"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-right">
                                                <!-- <div class="pull-right"> -->
                                                    <!--
                                                    ...
                                                    -->
                                                    <button id="btn_test_direct_printer" data-id="1" data-session="SESSONDATA" class="btn btn-default btn-small" type="button" style="display: inline;">
                                                    ...
                                                    <button id="btn_test_bluetooth_printer" data-id="1" data-session="SESSONDATA" class="btn btn-default btn-small" type="button" style="display: inline;">
                                                        <i class="fas fa-print"></i>
                                                        Print BT From Trans ID
                                                    </button>
                                                    <button id="btn_test_bluetooth_printer_url" data-id="23" data-session="SESSONDATA" class="btn btn-default btn-small" type="button" style="display: inline;">
                                                        <i class="fas fa-print"></i>
                                                        Print BT From URL
                                                    </button>                                                                                                                                                                                                                                                                  
