<script>
    $(document).ready(function () {
        ...
        upload_crop_img = $('#modal_croppie_canvas').croppie({
            enableExif: true,
            viewport: {width: image_width, height: image_height, type:'circle'},
        ...
        $(document).on("click", "#btn-save", function (e) {
            ...
            if (next == true) {
                var prepare = {
                    ...
                    file: $("#files_preview").attr('data-save-img')                    
                }
