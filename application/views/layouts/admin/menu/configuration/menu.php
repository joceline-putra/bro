                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-right">
                                    <div class="pull-right">
                                        <button id="btn_parent_menu" onClick="" class="btn btn-default btn-small" type="button"
...
<div class="modal fade" id="modal_parent" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content"> 
            <div class="modal-header" style="background-color: #6F7A8A;">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">  
                        <div class="col-md-12 col-xs-12 table-responsive">
                            <table id="table_parent" class="table table-bordered" style="width:100%;">
                                <thead>
                                    <tr>
                                        <th>Menu</th>
                                        <th>Action</th>                                        
