...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/core/favicon.png" type="image/png">
...
<body class="<?php echo $body_class; ?>"> <!-- horizontal-menu -->
  	...
  	<script type="text/javascript">
		$(document).ready(function() {
			...
			function transaction_over_due(trans_type){
				if(trans_type == 1){
					var form_data = {
						action:'load-report-purchase-buy-account-payable-dashboard',
					...
					var form_data = {
						action:'load-report-sales-sell-account-receivable-dashboard',
	...
	<!-- <script src="<?php echo base_url();?>pwa.min.js" type="text/javascript"></script> -->
	<script>
