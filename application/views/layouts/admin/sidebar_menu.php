    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
        ...
        <ul id="sidebar" style="" class="sidebarz">
            ...
            <?php if ($next == false) { ?>
                ...
                <li class="start"> 
                    <a href="<?php echo base_url('contact/customer'); ?>">
                        <i class="fa fa-address-book"></i>
                        <span class="title">Customer</span> <span class="selected"></span>
                    </a>
                </li>
                <li class="start"> 
                    <a href="<?php echo base_url('contact/supplier'); ?>">
                        <i class="fa fa-address-book"></i>
                        <span class="title">Supplier</span> <span class="selected"></span>
                    </a>
                </li>                  
                <!-- <li class="start"> 
            ...
            if ($next) {
                ...
                if ($session['user_data']['menu_access']) {
                    ...
                    foreach ($menu as $key => $value) {
                        ...
                        if ($value['menu_group_id'] != 44) { // != Report
                            ?>
                            <li class="start open"> 
                                ...
                                <ul class="open sub-menu" style="display:block;">
                                    ...
                                    // Menu only show for ROOT
                                    if ($value['menu_group_id'] == 49) {
                                        if($session['user_data']['user_id'] == 1){ ?>
                                            <li data-menu=""> 
                                                <a id="mconfiguration/menu" data-id="21" href="<?php echo base_url('configuration/menu'); ?>">
                                                    <!-- fas fa-vials -->
                                                    Menu
                                                </a> 
                                            </li>                                    
            ...
            if ($next) {            
                ...
                <li class="start"> 
                    <a href="#">
                        ...
                        <span class="title">Under Developmennt </span> <span class="selected"></span>
                    </a>
                    <!-- <li class="start open visible-xs visible-sm hidden-md hidden-lg">  -->
                    <li class="start open">
                        <ul class="open sub-menu" style="display:block;">
